(function() {
  ...
  Game2.prototype = {
    ...
    create: function () {
      ...
      this.ammo = this.add.sprite(ammoX, 200, 'image');
      this.ammo.width = 16;
      this.ammo.height = 16;
      this.ammo.anchor.setTo(0.5, 0.5);        
      
      this.scoreText = this.add.bitmapText(x, 420, ''+this.score+'ft', {font: '12px minecraftia', align: 'center'});
    ...
    update: function () {
      ...
      for(var i=0; i < this.debris.length; i++){
        ...
        this.physics.collide(this.player, this.ammo, this.collisionHandler2, null, this);   
      //action lines
      for(var i=0; i < 200; i++){
